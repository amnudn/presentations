...
\maketitle
\section{The paper}
\label{sec:orgbb79f1f}
\begin{frame}[label={sec:org9c31f6c}]{The paper}
\hfill
...
\begin{frame}[label={sec:orgbf53fd0}]{Discussion paper}
\begin{itemize}
...
\begin{frame}[label={sec:orgf01a8ca}]{Overall idea}
...
\begin{frame}[label={sec:org8722b2e}]{One consequence}
\begin{center}
...
\begin{frame}[label={sec:org7b47f1f}]{Is this a problem?}
...
\begin{frame}[label={sec:org677b364}]{Interpretation of ``slopes'' in the presence of non-linearity}
\begin{onlyenv}<1>
\begin{center}
...
\label{sec:org0031953}
\begin{frame}[label={sec:orgb6979c1}]{Comments}
\end{frame}
\begin{frame}[label={sec:orgf2a7e48}]{The best approximation depends on how you measure}
\begin{quote} %% 
...
\begin{frame}[label={sec:orgb96dd0c}]{Predictive performance}
...
\begin{frame}[label={sec:org3c50fcd}]{The best approximation is ill-defined when data is coarsened}
\begin{center}
...
\label{sec:orgf12e3a3}
\begin{frame}[label={sec:org31b84cb}]{Fully non-parametric (model-free) parameter definition}

...
\maketitle
\begin{frame}[label={sec:org072dee7}]{Motivation}
...
\begin{frame}[label={sec:org89e8fb2}]{Target and nuisance parameters}
...
\begin{frame}[label={sec:orgca678af}]{}
...
\begin{frame}[label={sec:orgb22b288}]{Multivariate shape constraints}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org55b8e5d}]{Machine learning (from the shelf)}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org3527922}]{Shape constraints}
...
\begin{frame}[label={sec:org87b6ac8}]{Information bounds}
...
\begin{frame}[label={sec:orgb5c93e0}]{(Un)necessary restrictions on nuisance parameters?}
...
\begin{frame}[label={sec:org490379c}]{Estimating a cumulative distribution function}
\small
...
\begin{frame}[label={sec:org4090a25}]{Challenges for future research}
\begin{itemize}
...
\begin{frame}[label={sec:org963708c}]{References}

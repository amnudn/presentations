...
\maketitle
\section{The paper}
\label{sec:org6e505aa}
\begin{frame}[label={sec:org3bc3b0c}]{The paper}
\hfill
...
\begin{frame}[label={sec:org53f964e}]{Discussion paper}
\begin{itemize}
...
\begin{frame}[label={sec:org9c71097}]{Overall idea}
...
\begin{frame}[label={sec:org29d6914}]{One consequence}
\begin{center}
...
\begin{frame}[label={sec:orgde5f9ad}]{Is this a problem?}
...
\begin{frame}[label={sec:org5a87b1d}]{Interpretation of ``slopes'' in the presence of non-linearity}
\begin{onlyenv}<1>
\begin{center}
...
\label{sec:org7881ea2}
\begin{frame}[label={sec:orgfbad0c1}]{Comments}
\end{frame}
\begin{frame}[label={sec:org257e1af}]{The best approximation depends on how you measure}
\begin{quote} %% 
...
\begin{frame}[label={sec:org6e4ecdc}]{Predictive performance}
...
\begin{frame}[label={sec:org4251346}]{The best approximation is ill-defined when data is coarsened}
\begin{center}
...
\label{sec:orga8aa894}
\begin{frame}[label={sec:orgde31278}]{Fully non-parametric (model-free) parameter definition}

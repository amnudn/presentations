...
\label{sec:orgdfbd79f}
\begin{frame}[label={sec:org6d95ffa}]{Selecting a model from a collection of candidate models}
...
\begin{frame}[label={sec:org1a593a1}]{A loss function for survival data}
\small
...
\label{sec:org8cb9ae7}
\begin{frame}[label={sec:org12993d6}]{Kullback-Leibler divergence and partial likelihoods}
...
\begin{frame}[label={sec:org89f4276}]{Least false model depends on the censoring distribution}
...
\begin{frame}[label={sec:org1943802}]{Sketch of proof}
\small
\begin{itemize}
...
\begin{frame}[label={sec:org24e54be}]{A simple example with misspecified survival models}
...
\label{sec:org5d12878}
\begin{frame}[label={sec:org4632f5e}]{Survival curve estimators evaluated on hold-out samples}
...
\begin{frame}[label={sec:org3c391f8}]{Taking the censoring distribution into account}
...
\begin{frame}[label={sec:org2a5f796}]{Modeling the censoring distribution}
...
\section*{Conclusion}
\label{sec:org02d512a}
\begin{frame}[label={sec:orgd2501f6}]{Conclusion}
\begin{beamercolorbox}[rounded=true]{gray}
...
\section*{References}
\label{sec:org8ab8fa4}
\begin{frame}[label={sec:org362c9e9}]{References}

...
\begin{frame}[label={sec:org3afacc4}]{Paper}
...
\begin{frame}[label={sec:orgad2fa60}]{Focus}
Conceptual focus.
...
\begin{frame}[label={sec:org6229ac7}]{Major points}
...
\begin{frame}[label={sec:org7d4cc0e}]{Motivation}
...
\begin{frame}[label={sec:org52bfb86}]{Some notation and setup}
...
\begin{frame}[label={sec:org06ff19d}]{Stage 1 \small (p.9)}
\begin{center}
...
\begin{frame}[label={sec:org036b12f}]{Stage 2 \small (p.9)}
\begin{center}
...
\begin{frame}[label={sec:org63321c8}]{Summary of the proposal}
...
\begin{frame}[label={sec:org96a3470}]{Conditional (data-adaptive) estimands \small (p.12)}
\begin{center}
...
\begin{frame}[label={sec:org02c277e}]{Example of feature: Best Linear Prediction (BLP) \small (compare p.12)}
...
\begin{frame}[label={sec:orgea8fd40}]{Why conditioning on data?}
...
\begin{frame}[label={sec:org79e4aea}]{Definition and interpretation of the estimand \small (p.21)}
\begin{center}
...
\begin{frame}[label={sec:orgb05fc38}]{Definition and interpretation of the estimand -- my attempt}
...
\begin{frame}[label={sec:org12fdc86}]{Interpretation of null hypothesis}
\begin{center}
...
\begin{frame}[label={sec:orgaa93f31}]{Applied analysis}
Immunization (vaccination?) of children i North India (against
measles?).
\end{frame}

\begin{frame}[label={sec:org0a46b80}]{Interpretation of results}
\begin{center}
...
\begin{frame}[label={sec:orgaad71cd}]{Interpretation of results}
\begin{center}
...
\begin{frame}[label={sec:org6f2e7d1}]{Addendum: Best approximation of CATE (in RCTs)}

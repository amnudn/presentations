...
\maketitle
\begin{frame}[label={sec:orgd0175ea}]{Motivation}
...
\begin{frame}[label={sec:orgc3ae167}]{Target and nuisance parameters}
...
\begin{frame}[label={sec:orga712c78}]{}
...
\begin{frame}[label={sec:org7fd132f}]{Multivariate shape constraints}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org21a6501}]{Machine learning (from the shelf)}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org2448f96}]{Shape constraints}

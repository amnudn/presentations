...
\begin{frame}[label={sec:orge2f1c0d}]{A loss function for survival data}
\small
...
\begin{frame}[label={sec:orge0dc034}]{Sketch of proof}
\small
\begin{itemize}
...
\begin{frame}[label={sec:orgc7c8242}]{Taking the censoring distribution into account}
...
\section*{Conclusion}
\label{sec:org8da3b9c}
\begin{frame}[label={sec:orgcf2b242}]{Conclusion}
\begin{beamercolorbox}[rounded=true]{gray}
...
\section*{References}
\label{sec:org49a10cf}
\begin{frame}[label={sec:org6dd70c1}]{References}

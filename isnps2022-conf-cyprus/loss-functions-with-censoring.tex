...
\institute{Coffee Talk \\ Section of Biostatistics}
...
\label{sec:orgb4e3523}
\begin{frame}[label={sec:org85819c0}]{Selecting a model from a collection of candidate models}
...
\begin{frame}[label={sec:orgc9d4cad}]{A loss function for survival data}
\small
...
\label{sec:org330a4c6}
\begin{frame}[label={sec:org7b678da}]{Kullback-Leibler divergence and partial likelihoods}
...
\begin{frame}[label={sec:orgcf91117}]{Least false model depends on the censoring distribution}
...
\begin{frame}[label={sec:org7a3dbfa}]{Sketch of proof}
\small
\begin{itemize}
...
\begin{frame}[label={sec:orgfdf3ae8}]{A simple example with mis-specified survival models}
...
\label{sec:org8290774}
\begin{frame}[label={sec:orgc1dee31}]{Survival curve estimators evaluated on hold-out samples}
...
\begin{frame}[label={sec:orga836479}]{Taking the censoring distribution into account}
...
\begin{frame}[label={sec:orgfa675af}]{Modeling the censoring distribution}
...
\section*{Conclusion}
\label{sec:orgb457192}
\begin{frame}[label={sec:org02e07d6}]{Conclusion}
\begin{beamercolorbox}[rounded=true]{gray}
...
\section*{References}
\label{sec:org531c275}
\begin{frame}[label={sec:orga28e0d0}]{References}

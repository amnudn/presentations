...
\maketitle
\begin{frame}[label={sec:org5852d92}]{Motivation}
...
\begin{frame}[label={sec:orgfa6f328}]{}
...
\begin{frame}[label={sec:org12aae74}]{Multivariate shape constraints}
\begin{figure}[htbp]
\centering
...
\begin{frame}[label={sec:org5ca159e}]{Machine learning (from the shelf)}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org7d666ee}]{Shape constraints}
...
\begin{frame}[label={sec:orgd8bf389}]{Information bounds}
...
\begin{frame}[label={sec:org7d82c30}]{(Un)necessary restrictions on nuisance parameters?}

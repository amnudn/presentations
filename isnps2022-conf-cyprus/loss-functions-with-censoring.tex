...
\begin{frame}[label={sec:org8d8ad0a}]{Sketch of proof}
\small
\begin{itemize}
...
\begin{frame}[label={sec:orgce5d74c}]{Taking the censoring distribution into account}
...
\section*{Conclusion}
\label{sec:org7fb6e72}
\begin{frame}[label={sec:orgd8980c8}]{Conclusion}
\begin{beamercolorbox}[rounded=true]{gray}
...
\section*{References}
\label{sec:orgcebeb63}
\begin{frame}[label={sec:org296fd94}]{References}
